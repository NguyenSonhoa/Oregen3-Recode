...
import me.banbeucmas.oregen3.hook.economy.VaultEconomyHook;
...
public class Oregen3 extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        sender.sendMessage("");
        sender.sendMessage("   §fRecoded By SonNguyen");
        ...
        PluginCommand mainCommand = Objects.requireNonNull(getCommand("oregen3"));
        mainCommand.setExecutor(commandHandler);
        mainCommand.setTabCompleter(commandHandler);

        // Register new aliases commands
        String[] aliases = {"gen", "ore", "nangcapgen"};
